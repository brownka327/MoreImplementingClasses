...
class Line(object):
    ...
    def clone(self):
        ...
        startclone = self.start.clone()
        endclone = self.end.clone()
        self.number_of_clones += 1

        return Line(startclone, endclone)
    ...
    def midpoint(self):
        ...
        x_mid = ((self.end.x - self.start.x)/2)+self.start.x
        y_mid =  ((self.end.y - self.start.y)/2)+self.start.y
